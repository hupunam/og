...
while true; do
    ...
    echo -e "🧱 LOGS: \033[0;32m$log_display\033[0m | 🌐 CURRENT: \033[0;35m$remote_display\033[0m | 🤝 PEERS: \033[0;34m$peers_display\033[0m | STATUS: ${color}${status}\033[0m $eta_display"
